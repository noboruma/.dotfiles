...
let s:I1 = [ '#ffffff' , '#ff0000' , 231 , 196 ]
let s:I2 = [ '#ffffff' , '#ff5f00' , 231 , 203 ]
let s:I3 = [ '#ffffff' , '#ff8f8f' , 160 , 224 ]
...
let s:V1 = [ '#ffffff' , '#00875f' , 255 , 29  ]
let s:V2 = [ '#005f00' , '#00df87' , 22  , 42  ]
let s:V3 = [ '#005f5f' , '#afff87' , 23  , 156 ]
