...
noremap <F4> :AsyncRun -program=make -cwd=`pwd`/ @ -j4<left><left><left><left><left><left><tab><tab>
nnoremap <F5> :up<cr>:AsyncRun -program=make<Up><cr>
inoremap <F5> <esc>:up<cr>:AsyncRun -program=make<Up><cr>
